...
public class SistemeCalc extends Echipament
{
    ...
    public SistemeCalc(String denumire,int nr_inv,int pret,ZonaMag zonaMag,Stare stare,TipMonitor tipMonitor, double vit_proc, int c_hdd, SistemOperare sistemOperare)
    {
    ...
    public String toString() {
        return  super.toString() +"SistemeCalc{" +
